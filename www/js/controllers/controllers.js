...
define(function (require) {
    ...
    controllers.controller('FileBrowserModalCtrl', require('controllers/imageViewer/FileBrowserModalCtrl'));
    ...
    controllers.controller('CarouselCtrl', require('controllers/effects/CarouselCtrl'));
