...
define(['angular'], function (angular) {
    "use strict";
    var directive = function ($ionicGesture, $ionicScrollDelegate) {
            ...
            link: function (scope, element, attrs) {
                ...
                var touchHold = function touchHold(e) {
                    ...
                    if (dragging) {
                        ...
                        initAutoScroll();
                        scrollInterval = window.setInterval(autoScroll, 20);
                    }
                };
                ...
                var initAutoScroll = function initAutoScroll() {
                    touchY = -1;
                    var scrollArea = element.closest('.scroll-content');
    ...
    directive.$inject = ['$ionicGesture', '$ionicScrollDelegate'];
    return directive;
});
