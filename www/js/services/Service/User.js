...
define(['angular'], function (angular) {
    ...
    var factory = function ($q, $firebaseArray, $firebaseObject, FirebaseUrl) {
        ...
        this.getUserChangeCounter = function () {
            return $firebaseObject(usersRef.child(uid).child('counter'));
        };
        ...
        this.getUserLastSynchroTime = function () {
            return $firebaseObject(usersRef.child(uid).child('lastSynchroTime'));
        };
        ...
        this.triggerUserChange = function () {
            if (authData === null)
                return;
